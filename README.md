...
ระบบถูกเตรียมไว้แล้ว เหลือแค่วางไฟล์ mp3:

1. เอาไฟล์เพลงไปไว้ที่โฟลเดอร์ `assets/audio/`
2. ตั้งชื่อไฟล์เป็น `bg-home-loop.mp3`
3. รีเฟรชหน้าเว็บ

> ตอนนี้โค้ดจะโหลดจาก `assets/audio/bg-home-loop.mp3` อัตโนมัติ

### พฤติกรรมที่ระบบทำให้แล้ว

- หลังปลดล็อกด้วยหัวใจ + ผ่านหน้าโหลดแรก จะขึ้น popup บังคับให้กด “เปิดเพลงตอนนี้”
- เพลงจะเล่นเฉพาะหน้า `home`
- ระหว่างหน้าโหลดเปลี่ยนหน้า เพลงจะหยุด
- ออกจากโหลดกลับหน้า `home` แล้วจะเล่นต่อ
- เล่นแบบ loop ต่อเนื่อง
- เริ่มเล่นแบบค่อย ๆ เร่งความดัง (fade-in)
